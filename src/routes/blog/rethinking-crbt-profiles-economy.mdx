...
CRBT Profiles still have their own distinctive features, namely the "Birthday" and "Website" fields, and I had planned to integrate them more into the ecosystem with the addition of profile vanity URLs (e.g. https://crbt.ga/@Clembs would bring up my CRBT Profile page).
...
So theoretically, users will be able to visit https://crbt.ga/@Clembs and get a mix of my Discord profile, with some CRBT-specific fields thrown in there.
