...
export default function Policy({ mdx }) {
  return (
    <div className={c.root}>
      <Head>
        <title>CRBT - October 2021 Update</title>
        <meta property="og:title" content="CRBT - October 2021 Update" />
...
export async function getStaticProps() {
  const policyMd = (await readFile('pages/blog/october-2021-changelog.md')).toString();
