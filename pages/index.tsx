  ...
  return (
    <div className={c.root}>
      <Head>
        ...
        <meta
          name="description"
          content="The Discord companion made for you. Created by Clembs."
        />
        <meta
      ...
      <div className={c.noiselayer}>
        <h2 className={c.why}>Why CRBT?</h2>
      </div>
      ...
      <section className={c.section1}>
        <div className={c.text}>
          ...
          <p>
            CRBT was made to look just right with its gorgeous UI and its ton of
            customization so you can tune it to look, feel, and behave however
            you prefer it to for not only your server, but also you.
          </p>
        </div>
        <div className={c.spacer} />
